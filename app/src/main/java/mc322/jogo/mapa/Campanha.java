...
public class Campanha {
    ...
    public static NoMapa criarMapa(GameManager gm, int dificuldade, InterfaceUsuario ui) {
        ...
        NoMapa n1_batalha = new NoMapa(new Batalha(
                "Batalha",
                Cores.VERMELHO + Cores.NEGRITO + "Aldeão: " + Cores.RESET
                        + "Renda-se, monstro! Em nome de Lord Farquaad!\n" +
        ...
        NoMapa n10_flores = new NoMapa(new EventoEscolha(
                "Encruzilhada",
                Cores.NEGRITO + "Narrador: " + Cores.RESET
                        + "Shrek continua sua jornada pela floresta e encontra uma encruzilhada.\n" +
                        Cores.AZUL + Cores.NEGRITO + "Shrek: " + Cores.RESET
                        + "Flor azul com espinhos vermelhos... ou flor vermelha com espinhos azuis? Qual caminho eu pego?\n"));
        ...
        NoMapa n21_burro = new NoMapa(new Batalha(
            ...
            public void darRecompensaExtra(Jogador jogador, GameManager gm) {
                ui.mostrarNovoCompanheiro("Burro");
        ...
        NoMapa n31_golpe = new NoMapa(new EventoRecompensa(
                "Caminho bonito",
                Cores.NEGRITO + "Narrador: " + Cores.RESET
                        + "O Burro não para de falar, mas você acha um pergaminho antigo no chão.",
        ...
        NoMapa n22_pinoquio = new NoMapa(new Batalha(
            ...
            @Override
            public void darRecompensaExtra(Jogador jogador, GameManager gm) {
                ui.mostrarNovoCompanheiro("Pinoquio");
        ...
        NoMapa n44_batalha = new NoMapa(new Batalha(
                "Cabana",
                Cores.VERMELHO + Cores.NEGRITO + "Mascote do Lord: " + Cores.RESET
                        + "Ei, essa é minha casa! Em nome de Farquaad, você morre aqui!",
                carregaInimigoGenerico(gm, () -> Dados.criarFarquadMascot(gm), dificuldade),
                false));
        ...
        NoMapa n45_golpe = new NoMapa(new EventoRecompensa(
                "Quintal de uma casa",
                Cores.NEGRITO + "Narrador: " + Cores.RESET
                        + "Você encontra uma máscara do farquad. Parece de um mascote...",
        ...
        NoMapa n46_golpe = new NoMapa(new EventoRecompensa(
                ...
                Cores.NEGRITO + "Narrador: " + Cores.RESET
                        + "Você encontra uma panela de ferro. Excelente para proteger a cabeça.",
        ...
        NoMapa n61_torre_bruxa = new NoMapa(new Batalha(
            ...
            @Override
            public void darRecompensaExtra(Jogador jogador, GameManager gm) {
                ui.mostrarNovoCompanheiro("Fiona");
        ...
        NoMapa n81_batalha = new NoMapa(new Batalha(
                "Voltar agora",
                Cores.NEGRITO + "Narrador: " + Cores.RESET
                        + "Após derrotar o cavaleiro, Thelonius descobre e envia capangas...\n" + Cores.VERMELHO
                        + Cores.NEGRITO + "Capangas: " + Cores.RESET + "Lá está ele. Atacar!\n",
