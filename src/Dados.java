...
public class Dados {
    ...
    public static Baralho carregarBaralhoGeral() {
        ...
        deck.adicionaBaralho(
                new CartaDano("Invocação do Dragão Aliado", "Custa 5 de energia e causa 50 de dano", 5, 50, 0));

        /* todas as cartas de escudo */
        deck.adicionaBaralho(new CartaEscudo("Proteção", "Custa 3 de energia e recebe 20 de escudo", 3, 20, 1));
        deck.adicionaBaralho(
                new CartaEscudo("Beijo de amor verdadeiro", "Custa 4 de energia e recebe 50 de escudo", 4, 50, 1));
        deck.adicionaBaralho(new CartaEscudo("Botas de Couro", "Custa 1 de energia e recebe 10 de escudo", 1, 10, 1));
        deck.adicionaBaralho(
                new CartaEscudo("Camadas de Cebola", "Custa 1 de energia e recebe 12 de escudo", 1, 12, 1));
        deck.adicionaBaralho(
                new CartaEscudo("Waffles Quentinhos", "Custa 2 de energia e recebe 18 de escudo", 2, 18, 1));
        deck.adicionaBaralho(
                new CartaEscudo("Pele Verde e Grossa", "Custa 3 de energia e recebe 25 de escudo", 3, 25, 1));
        deck.adicionaBaralho(new CartaEscudo("Panela de Lama", "Custa 2 de energia e recebe 20 de escudo", 2, 20, 1));
        deck.adicionaBaralho(
                new CartaEscudo("Muralha do Castelo do Dragão", "Custa 5 de energia e recebe 60 de escudo", 5, 45, 1));

        /* todas as cartas de efeito */
        deck.adicionaBaralho(new CartaEfeito("Hálito Matinal de Ogro", "Aplica 5 de Veneno. É pior que cebola podre.",
                3, 2, TiposEfeitos.VENENO, 10));
        deck.adicionaBaralho(new CartaEfeito("Ensopado de Olho de Peixe", "Aplica 12 de Veneno. Custa 3 de energia.", 3,
    ...
    public static ArrayList<Inimigo> carregarInimigos() {
        ...
        deckDragao.add(new CartaEfeito("Gargalhada suprema",
                "O Lord Gargalha durante uma série de turnos e causa dano", 3, 2, TiposEfeitos.VENENO, 10)); //teste
        ...
        deckFarquaad.add(new CartaEfeito("Gargalhada suprema",
                "O Lord Gargalha durante uma série de turnos e causa dano", 3, 2, TiposEfeitos.VENENO, 10));
        ...
        deckFada.add(new CartaEfeito("Gargalhada suprema",
                "O Lord Gargalha durante uma série de turnos e causa dano", 3, 2, TiposEfeitos.VENENO, 10)); // teste
